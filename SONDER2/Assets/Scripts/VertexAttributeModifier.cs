...
public class VertexAttributeModifier : MonoBehaviour {
    ...
    public enum AnimationMode { VertexColor, UiVertexColor, Wave, Jitter, Warp, WarpUI, Dangling, Reveal, Skew};
    ...
    void Start()
    {
        ...
        switch (MeshAnimationMode)
        {
            ...
            case AnimationMode.Reveal:
                ...
                break;
            case AnimationMode.Skew:
               StartCoroutine(AnimateVertexPositionsVII());
               break;
